 ...
 * 2018-07-06T11:02:05.773+08:00
 * Generated source version: 3.1.11
 * 
 */
@WebServiceClient(name = "UserServiceService", 
                  wsdlLocation = "http://localhost:8080/Spring-CXF-Server/ws/user?wsdl",
                  targetNamespace = "http://service.bfchengnuo.com/") 
public class UserServiceService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://service.bfchengnuo.com/", "UserServiceService");
    public final static QName UserServicePort = new QName("http://service.bfchengnuo.com/", "UserServicePort");
    static {
        URL url = null;
        try {
            url = new URL("http://localhost:8080/Spring-CXF-Server/ws/user?wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(UserServiceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "http://localhost:8080/Spring-CXF-Server/ws/user?wsdl");
        }
        WSDL_LOCATION = url;
    }
