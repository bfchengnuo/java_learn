public class DecoratorMain {
	 ...
	 * 装饰模式在不必改变原类文件和使用继承的情况下，动态的扩展一个对象的功能。
	 * 它是通过创建一个包装对象，也就是装饰来包裹真实的对象。
	 * 
	 * 2、为什么使用装饰模式？
	 * 我们通常使用继承来实现功能的扩展，如果这些需要扩展的功能的种类很繁多，那么势必会生成很多子类，增加系统的复杂性。
	 * 同时，使用继承实现功能扩展，必须先知道这些扩展功能的作用，这些功能是在编译时就确定了的，是静态的。
	 ...
	 * 
	 * 4、装饰模式与继承的区别？ 
	 * 装饰模式 ：用来扩展特定对象的功能 ；不需要子类 ；运行时分配职责；防止由于子类而导致的复杂和混乱；更多的灵活性
	 * 继承 ： 用来扩展一类对象的功能 ；需要子类 ； 编译时分配职责；导致很多子类产生；缺乏灵活性
	 * 
	 */
