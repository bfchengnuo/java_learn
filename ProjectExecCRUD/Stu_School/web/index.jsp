        ...
        <div class="row">
            <div class="col-md-2">
                ...
                <div id="left" class="list-group">
                    <a href="welcome.jsp" target="et" class="list-group-item active" onclick="change(this)">学生管理系统</a>

                    <a href="addsc.jsp" target="et" class="list-group-item" onclick="change(this)">添加学校</a>
                    <a href="addstu.jsp" target="et" class="list-group-item" onclick="change(this)">添加学生</a>
                    <a href="stulist.jsp" target="et" class="list-group-item" onclick="change(this)">学生列表</a>
                </div>
            </div>
            <div class="col-md-10">
